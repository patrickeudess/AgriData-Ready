...
.step-card {
    ...
    border-left: 5px solid #4CAF50; box-shadow: 0 2px 8px rgba(0,0,0,0.06); margin-bottom: 0.8rem;
}
.step-card.active { border-left-color: #FF6F00; background: #FFF8E1; }
.step-card.done { border-left-color: #1B5E20; background: #E8F5E9; }
.metric-card {
    background: white; border-radius: 10px; padding: 1rem; text-align: center;
    box-shadow: 0 2px 6px rgba(0,0,0,0.06); border-top: 4px solid #4CAF50;
}
.metric-val { font-size: 1.8rem; font-weight: 800; color: #1B5E20; }
...
.quality-issue.good { background: #E8F5E9; border-left-color: #1B5E20; }
...
.reco-important { background: #FFF3E0; border-left: 4px solid #FF6F00; }
.reco-improve { background: #E8F5E9; border-left: 4px solid #1B5E20; }
...
def generate_html_report(df, metadata, variable_docs, quality_report, fair_score, ai_score, recommendations, edit_history):
    ...
    html = f"""<!DOCTYPE html>
<html lang="fr">
<head><meta charset="UTF-8"><title>Rapport AgriData Ready</title>
<style>
...
<body>
<div class="header">
<h1>AgriData Ready - Rapport Final</h1>
...
<hr><p style="text-align:center;color:#888;font-size:0.8rem">AgriData Ready &mdash; From Raw Data to FAIR & AI-Ready Data</p>
</body></html>"""
    return html
